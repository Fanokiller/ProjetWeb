            ...
            <div class="w-full md:w-1/2 p-3 mx-auto">
                <div class="bg-red-100 border border-gray-800 rounded shadow p-2 text-center">
                    <div class="flex flex-row">
                        <span class="text-center font-bold text-5xl text-white mx-auto">
                            <div>
                                <h1 class=" bg-red-300 border rounded border-b-2 border-gray-500"> Saucisse apéro </h1>
                                <span class="mx-auto"><i class="text-black fas fa-stopwatch" style="color:black"></i></span><p>20 minutes</p>
                                <i class="fas fa-circle h-10 w-10" style="color:gray"></i>
                                <i class="fas fa-circle h-10 w-10" style="color:gray"></i>
                                <i class="fas fa-circle h-10 w-10" style="color:white"></i>
                                <i class="fas fa-circle h-10 w-10" style="color:white"></i>
                                <i class="fas fa-euro-sign"style="color:gray"></i>
                                <i class="fas fa-user-alt" style="color:gray"></i><br>
                            </div>
                    ...
                    <div class="w-full p-3 border border-grey-300 rounded shadow p-2">
                        ...
                        <div class="flex justify-between">
                            <button><span class="mx-auto"><i class="far fa-file-pdf fa-2x"></i></span></button>                            <button><span class="mx-auto"><i class="far fa-share-square fa-2x"></i></span></button>
