    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        <div class="flex flex-wrap mt-12">
            <div class="w-full md:w-1/2 p-3 mx-auto">
                <div class="bg-red-100 border border-gray-800 rounded shadow p-2 text-center">
                    <div class="container pb-4 pt-2 bg-light border rounded border-light">
                        <span class="text-center font-bold text-5xl mx-auto">
                            <div class="col-sm">
                                <h1 class=" bg-red-300 border rounded border-b-2 border-gray-500"> Saucisse apéro </h1></span>             
                            </div>     
                    <div class="flex inline-block text-left">
                    <table class="table-auto">
  <thead>
    <tr>
      <th class="px-4 py-2 items-center inline-block justify-between"><i class="text-black fas fa-stopwatch" style="color:black"></i></th>
      <th class="px-4 py-2">facilité</th>
      <th class="px-4 py-2"><i class="fas fa-user-alt" style="color:gray"></i></th>
      <th class="px-4 py-2"><i class="fas fa-euro-sign"style="color:gray"></i></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td class="border px-4 py-2 inline-block"><i class="fas fa-circle h-10 w-10" style="color:green"></i><i class="fas fa-circle h-10 w-10" style="color:green"></i><i class="fas fa-circle h-10 w-10" style="color:gray"></i><i class="fas fa-circle h-10 w-10" style="color:gray"></i></td>
      <td class="border px-4 py-2">4 personnes</td>
      <td class="border px-4 py-2">Bon marché</td>
    </tr>
  </tbody>
</table>
                        <br>
                ...
                <div class="w-full p-3 border border-grey-300 rounded shadow p-2">
                    ...
                    <div class="flex flew-row bg-white rounded-lg">
                        <div class="flex-shrink-0 mb-8 bg-gray-600 rounded-lg">
                            ...
                            <tr class="border-4 border-gray-800">
                                ...
                                <p class="m-2"><img class="w-10 h-10 rounded-full mr-4 bg-gray-200 inline-block" src="https://images.anaca3.com/wp-content/uploads/2018/07/les-knackis-autorise-pendant-la-grossesse-702x336.jpg">1 paquet de knackis</p>
                                </td>
                                <td class="flex-none px-4 py-2 w-1/3" > 
                                <p class="m-2 -ml-3"><img class="w-10 h-10 rounded-full mr-4 bg-gray-200 inline-block" src="https://www.herta.fr/sites/default/files/images/product/principal/864b443e-88de-4573-bcb7-87e5b86d2e9d.png">1 pâte feuilletée</p>
                                </td>
                            </tr>
                        </tbody> -->
